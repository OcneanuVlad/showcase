...
!(function () {
  ...
  var v = (function () {
    function e(e) {
      s.set(this, {
        ...
        h(this, e && void 0 !== e.source ? e.source : document.scrollingElement),
          ...
          get: function () {
            ...
            var t = this.orientation,
              ...
              i = (function (e, t) {
                var n = "horizontal-tb" == getComputedStyle(e).writingMode;
                return (
                  "block" === t ? (t = n ? "vertical" : "horizontal") : "inline" === t && (t = n ? "horizontal" : "vertical"),
                  "vertical" === t ? e.scrollHeight - e.clientHeight : "horizontal" === t ? e.scrollWidth - e.clientWidth : void 0
                );
              })(e, t);
  ...
  function x(e, t, n, i, r) {
    ...
    "horizontal" == i || ("inline" == i && u) || ("block" == i && !u)
      ? ((m = n.clientWidth),
        (f = o),
        ("rtl" == c.direction || "vertical-rl" == c.writingMode) && (f += t.scrollWidth - t.clientWidth),
        (h = t.clientWidth))
    ...
    if (e.timeline) {
      ...
      if (i && null != e.startTime && !e.proxy.pending) {
        ...
        r > 0 && i >= a
          ...
          : 0 != r && (t && null !== e.holdTime && (e.startTime = U(e, e.holdTime)), (e.holdTime = null));
      }
      K(e),
        ...
        "finished" == e.proxy.playState
          ...
          : (e.finishedPromise && "resolved" == e.finishedPromise.state && (e.finishedPromise = new P()),
  ...
  function q(e, t) {
    ...
    e.animation.currentTime = t + (n.currentTime && n.currentTime.value == (i < 0 ? 0 : 100) ? (i < 0 ? 0.001 : -0.001) : 0);
  }
  function B(e, t) {
    if (e.timeline) {
      ...
      null != r && ((e.startTime = r), (e.holdTime = null), D(e)),
        ...
        (null !== e.holdTime || null !== r || n || null !== e.pendingPlaybackRate) &&
          (e.readyPromise && !i && (e.readyPromise = null), K(e), e.readyPromise || O(e), (e.pendingTask = "play"), H(e, !1, !1));
    }
  }
  function Y(e) {
    var t = G.get(this);
        ...
        (n.cancel = function () {
          ...
          e.timeline
            ? ("idle" != this.playState &&
                ((function (e) {
                  e.pendingTask &&
                    ((e.pendingTask = null), D(e), e.readyPromise.reject(L()), O(e), e.readyPromise.resolve(e.proxy));
                })(e),
                e.finishedPromise && "pending" == e.finishedPromise.state && e.finishedPromise.reject(L()),
        ...
        t(e, [
                        ...
                        i = {
                          apply: function (n) {
                            ...
                            if (e.timeline) {
                              ...
                              var r = F(e);
                              (i.duration = r
                                ? CSS.percent((100 * (i.iterations ? (r - i.delay - i.endDelay) / i.iterations : 0)) / r)
                                : CSS.percent(0)),
                          ...
                          apply: function (i, r) {
                            ...
                            return (
                              e.timeline instanceof ViewTimeline &&
                                ...
                                (c = !0)),
                              (null === s.duration || "auto" === s.duration || c) &&
                                e.timeline &&
                                (c ? ((s.delay = o * a), (s.endDelay = l * a)) : ((s.delay = 0), (s.endDelay = 0)),
                                (s.duration = s.iterations ? ((s.iterations ? a : 0) - s.delay - s.endDelay) / s.iterations : 0),
                                n.apply(t, [s])),
            ...
            set: function (e) {
              ...
              if (t != e) {
                ...
                if ((l && d(r.timeline, r.animation), s)) {
                  ...
                  return (
                    c &&
                      ((r.readyPromise && "resolved" != r.readyPromise.state) || O(r),
                ...
                if ((d(r.timeline, r.animation), (r.timeline = null), l))
                  switch ((null !== i && (r.animation.currentTime = o * F(r)), n)) {
                    case "paused":
                      r.animation.pause();
                      break;
                    case "running":
          ...
          },
          {
            ...
            set: function (e) {
              ...
              if (((e = W(t, e)), t.timeline && null != e)) {
                ...
                null !== t.holdTime || null === t.startTime || "inactive" == n || 0 == t.animation.playbackRate
                  ? (t.holdTime = e)
                  : (t.startTime = U(t, e)),
                  (t.resetCurrentTimeOnResume = !1),
                  ...
                  "pause" == t.pendingTask &&
                    ((t.holdTime = e), D(t), (t.startTime = null), (t.pendingTask = null), t.readyPromise.resolve(this)),
                  H(t, !0, !1);
          ...
          },
          {
            ...
            get: function () {
              var e = G.get(this);
              return e.timeline
                ? (e.finishedPromise || (e.finishedPromise = new P()), e.finishedPromise.promise)
          ...
          },
          {
            ...
            get: function () {
              var e = G.get(this);
              return e.timeline
                ? (e.readyPromise || ((e.readyPromise = new P()), e.readyPromise.resolve(this)), e.readyPromise.promise)
                : e.animation.ready;
            },
          },
        ]),
  ...
  function ee(e) {
    ...
    return (
      ...
      e["animation-end-delay"] && (t.end = $(e["animation-end-delay"], Z().offset)),
      t
    );
  }
  function te(e) {
    ...
    return (
      i.length && ((t.start.name = i[0]), (t.end.name = i.length > 1 ? i[1] : i[0])),
      r.length > 1 && ((t.start.offset = CSS.percent(r[0])), (t.end.offset = CSS.percent(r[1]))),
      t
    );
  }
  var ne = {
      ...
      return (
        (t.transpileStyleSheet = function (e, t, n) {
          for (
            ...
            if (this.lookAhead("/*", i)) for (; this.lookAhead("/*", i); ) this.eatComment(i), this.eatWhitespace(i);
            else {
        ...
        (t.handleScrollTimelineProps = function (e, t) {
          ...
          if (!e.selector.includes("@keyframes")) {
            ...
            r && (o = this.extractScrollTimelineNames(e.block.contents)),
              i && (l = this.extractMatches(e.block.contents, ne.ANIMATION_NAME)),
              (r && i) ||
                (a &&
                  this.extractMatches(e.block.contents, ne.ANIMATION).forEach(function (t) {
                    ...
                    a && (i.timelineName || r) && l.push(a),
                      (i.timelineName || r) &&
                        (n.hasDuration(t) || ((e.block.contents = e.block.contents.replace(t, " 1s " + t)), (s = !0))),
                      i.toBeReplaced &&
                        ((e.block.contents = e.block.contents.replace(i.toBeReplaced, " ".repeat(i.toBeReplaced.length))),
                        (s = !0));
                  }),
        ...
        (t.saveSourceSelectorToScrollTimeline = function (e) {
          ...
          if (n || i) {
            var a = [];
            if (n)
              for (var o, s = l(this.extractMatches(e.block.contents, ne.SCROLL_TIMELINE)); !(o = s()).done; ) {
            ...
            if (i)
              for (var u = this.extractMatches(e.block.contents, ne.SCROLL_TIMELINE_NAME), m = 0; m < u.length; m++)
                m < a.length ? (a[m].name = u[m]) : a.push({ selector: e.selector, name: u[m] });
            var f = [];
            r &&
              (f = (f = this.extractMatches(e.block.contents, ne.SCROLL_TIMELINE_AXIS)).filter(function (e) {
        ...
        (t.saveSubjectSelectorToViewTimeline = function (e) {
          ...
          if (n || i) {
            var o = [];
            if (n)
              for (var s, c = l(this.extractMatches(e.block.contents, ne.VIEW_TIMELINE)); !(s = c()).done; ) {
            ...
            if (i)
              for (var m = this.extractMatches(e.block.contents, ne.VIEW_TIMELINE_NAME), f = 0; f < m.length; f++)
                f < o.length ? (o[f].name = m[f]) : o.push({ selector: e.selector, name: m[f], inset: null });
            var h = [],
              d = [];
            a && (h = this.extractMatches(e.block.contents, ne.VIEW_TIMELINE_INSET)),
              r &&
                (d = (d = this.extractMatches(e.block.contents, ne.VIEW_TIMELINE_AXIS)).filter(function (e) {
                  return ie.includes(e);
                }));
            for (var p = 0; p < o.length; p++)
              h.length && (o[p].inset = h[p % o.length]), d.length && (o[p].axis = d[p % o.length]);
        ...
        (t.saveRelationInList = function (e, t, i) {
          ...
          r && (l = this.extractMatches(e.block.contents, ne.ANIMATION_DELAY)),
            a && (s = this.extractMatches(e.block.contents, ne.ANIMATION_END_DELAY)),
            o && (c = this.extractMatches(e.block.contents, ne.ANIMATION_TIME_RANGE));
          for (var u = Math.max(t.length, i.length, l.length, s.length, c.length), m = 0; m < u; m++)
          ...
          var n = e.block.contents,
            i = (function (e) {
              for (var t = 0, n = -1, i = [], r = 0; r < e.length; r++)
                "{" == e[r] ? t++ : "}" == e[r] && t--,
                  1 == t && "{" != e[r] && "}" != e[r] && -1 == n && (n = r),
                  2 == t && "{" == e[r] && (i.push({ start: n, end: r }), (n = -1));
              return i;
            })(n);
          ...
          for (
            var l = function (e) {
                ...
                t.split(",").forEach(function (e) {
                  ...
                  o.push(l.join(",")),
                  o.push(e == i.length - 1 ? n.substring(i[e].end) : n.substring(i[e].end, i[e + 1].start));
              },
              s = 0;
            s < i.length;
            s++
            ...
            l(s);
          return a
            ? ((e.block.contents = o.join("")), this.replacePart(e.block.startIndex, e.block.endIndex, e.block.contents, t), r)
            : new Map();
        }),
                ...
                var r = (function (e, t, n) {
                  ...
                  return a
                    ? (a.subject &&
                                  ...
                                  if (c[0] == 100 * r.offset) {
                                    if ("from" == u) o = 0;
                                      ...
                                      o =
                                        1 == m.length
                                          ? parseFloat(m[0])
                                          : 100 * oe(m[0], n, t.subject, i, t.inset, CSS.percent(parseFloat(m[1])));
                                    }
                                    break;
                                  }
                                }
                      ...
                      { timeline: a.source ? new v(a) : new N(a), animOptions: i })
                    : null;
